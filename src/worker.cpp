...
Worker::Worker(int tunnelMtu, const char *deviceName, bool answerEcho, uid_t uid, gid_t gid ,uint32_t bindIp)
{
    ...
    try
    {
        echo = new Echo(tunnelMtu + sizeof(TunnelHeader), bindIp);
