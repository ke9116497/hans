...
Server::Server(int tunnelMtu, const char *deviceName, const char *passphrase, uint32_t network, bool answerEcho, uid_t uid, gid_t gid, int pollTimeout, uint32_t bindIp)
    : Worker(tunnelMtu, deviceName, answerEcho, uid, gid, bindIp), auth(passphrase)
{
